                             ...
                             @foreach ($expiredOwners as $owner)
                              <tr>
                                ...
                                <form id="delete_{{$owner->id}}" method="post" action="{{ route('admin.expired-owners.destroy',['owner' => $owner->id ]) }}">
                                  ...
                                  <td class="px-4 py-3">
                                    <a href = "javascript:void(0);" data-id="{{ $owner->id }}" onclick="deletePost(this)" class="text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-500 rounded ">完全削除</a>
                                  </td>
                                </form>
                              </tr>
                              @endforeach
